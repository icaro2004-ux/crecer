...
//  LA PANTALLA
// ══════════════════════════════════════════════════════════════
//  ── LA SONDA MIRA ESTE ARBOL, Y NO GASTA ────────────────────────────────
//  El porque completo vive en tests/_arbol_servido.php: apunta la sonda aqui,
//  pone el centinela donde de verdad se lee, y le da al navegador la valla que
//  impide que las llamadas absolutas /crecer/... se vayan al arbol de la otra
//  rama, donde no hay centinela y se pagan. Antes de eso esto era un salto:
//  desde un worktree paralelo la parte de pantalla no se podia correr.
