...
<div class="layout">
  ...
  <div class="main">
    <div class="ptop">
      ...
      <a href="<?= $BASE ?>/calendario.php?marca=<?= $marca_id ?>" aria-label="Calendario" style="margin-right:16px;display:flex;align-items:center;text-decoration:none;font-size:22px;line-height:1;color:var(--teal)"><?= ico('calendar') ?></a>
