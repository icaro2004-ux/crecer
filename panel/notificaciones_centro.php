...
?>
<style>
  :root{--rosa:var(--magenta)}
  .ncwrap{max-width:640px;margin:0 auto}
  .ncwrap svg.ic{width:1.05em;height:1.05em;flex-shrink:0;vertical-align:-2px}
  .n{display:flex;gap:13px;align-items:flex-start;background:var(--card);border:1px solid var(--line);border-radius:16px;padding:14px 15px;margin-bottom:10px;text-decoration:none;color:inherit;transition:.15s}
  .n:hover{border-color:#d9d5de;transform:translateY(-1px)}
  .n.un{background:#fff5f8;border-color:#f6ccda}
  .n .em{font-size:22px;width:44px;height:44px;flex-shrink:0;border-radius:12px;background:var(--crema-2);display:flex;align-items:center;justify-content:center;color:var(--rosa)}
  .n.un .em{background:#ffe3ec}
  .n .tt{font-family:var(--font-display);font-weight:700;font-size:15px;line-height:1.25}
  ...
  .ndel{margin-left:6px;flex-shrink:0;background:none;border:0;cursor:pointer;font-size:16px;opacity:.35;padding:4px;transition:opacity .15s;color:var(--muted)}
  .ndel:hover{opacity:1}
  .hbar{display:flex;align-items:center;gap:10px;margin:2px 0 16px}
  .clr{margin-left:auto;background:var(--card);border:1px solid var(--line);border-radius:10px;padding:8px 14px;font-weight:700;font-size:13px;color:var(--muted);cursor:pointer;font-family:inherit}
...
<div class="ncwrap">
  <div class="hbar">
    <h1 style="margin:0;display:flex;align-items:center;gap:9px;font-family:var(--font-display);font-size:26px;font-weight:800"><?= ico('bell-solid') ?> Notificaciones</h1>
